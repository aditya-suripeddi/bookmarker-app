...
const nextConfig = {
  ...
  serverRuntimeConfig: {
    API_BASE_URL: process.env.SERVER_SIDE_BASE_URL  // configured in docker-app.yaml
  },

  publicRuntimeConfig: {
    API_BASE_URL: process.env.CLIENT_SIDE_BASE_URL // configured in docker-app.yaml
  },
